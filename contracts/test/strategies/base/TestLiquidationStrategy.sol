...
contract TestLiquidationStrategy is LiquidationStrategy { //TestLongStrategy, 
    ...
    function _getCFMMPrice(address cfmm, uint256 factor) external override pure returns(uint256) {
        return 1;
    }
