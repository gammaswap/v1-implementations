...
import "../../../strategies/deltaswap/lending/DSV2BorrowStrategy.sol";

contract TestDSV2BorrowStrategy is DSV2BorrowStrategy {
    ...
    constructor(address mathLib_, uint24 tradingFee1_, uint24 tradingFee2_, address feeSource_, uint64 baseRate_,
        uint64 optimalUtilRate_, uint64 slope1_, uint64 slope2_) DSV2BorrowStrategy(mathLib_, 1e19, 2252571,
