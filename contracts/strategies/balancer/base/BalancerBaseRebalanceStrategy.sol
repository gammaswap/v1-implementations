...
/// @notice Sets up variables used by BaseRebalanceStrategy and defines internal functions specific to Balancer implementation
/// @dev This implementation was specifically designed to work with Balancer
abstract contract BalancerBaseRebalanceStrategy is BaseRebalanceStrategy, BalancerBaseLongStrategy {

    error MissingMathLib();
    error CollateralIdGte2();

    uint256 constant tradingFee1 = 997;
    uint256 constant tradingFee2 = 1000;
