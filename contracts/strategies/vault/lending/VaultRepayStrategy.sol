...
import "../base/VaultBaseRepayStrategy.sol";

/// @title Vault Repay Strategy concrete implementation contract for Vault GammaPool Constant Product Market Maker
...
contract VaultRepayStrategy is RepayStrategy, VaultBaseRepayStrategy {
    ...
    function updateStore(uint256 lastFeeIndex, uint256 borrowedInvariant, uint256 lastCFMMInvariant, uint256 lastCFMMTotalSupply)
        internal virtual override(BaseStrategy,VaultBaseRepayStrategy) returns(uint256 accFeeIndex, uint256 newBorrowedInvariant) {
