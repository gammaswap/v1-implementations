...
contract CPMMLongStrategy is CPMMBaseStrategy, LiquidationStrategy {
    ...
    function beforeSwapTokens(Loan storage _loan, int256[] calldata deltas) internal virtual override returns(uint256[] memory outAmts, uint256[] memory inAmts) {
    ...
    function calcInAndOutAmounts(Loan storage _loan, uint256 reserve0, uint256 reserve1, int256 delta0, int256 delta1) internal returns(uint256 inAmt0, uint256 inAmt1, uint256 outAmt0, uint256 outAmt1) {
